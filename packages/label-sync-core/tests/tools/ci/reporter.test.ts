...
describe('ci sync reporter', () => {
  test('correctly creates a report', async () => {
    const report: SyncReport = {
      ...
      options: { dryRun: false, skipSiblingSync: false },
      syncs: [
        {
          status: 'success',
          repository: {
  ...
  test('correctly creates a report when skipping siblings', async () => {
    const report: SyncReport = {
      config: {
        'maticzav/label-sync': { labels: { basic: '123123' }, strict: false },
        'maticzav/graphql-shield': {
      ...
      options: { dryRun: false, skipSiblingSync: true },
      syncs: [
        {
          status: 'success',
          repository: {
  ...
  test('correctly creates an empty report when skipping siblings', async () => {
    const report: SyncReport = {
      config: {
        'maticzav/label-sync': { labels: { basic: '123123' }, strict: false },
        'maticzav/graphql-shield': {
